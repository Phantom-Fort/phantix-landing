...
const faqs = [
  {
    ...
    a: "SecureGraph is a security operations platform built specifically for organizations that have one security person \u2014 or someone wearing the security hat alongside other responsibilities. It brings together everything you need: asset inventory, vulnerability assessment, penetration testing, risk management, compliance tracking, and board-ready reporting. All from one dashboard.\n\nWhat makes us different is how we handle your data. Your security records \u2014 assets, findings, risks, evidence \u2014 live in a database you control. We never copy or store your production business data. And every finding that reaches a report is verified, so you never have to explain a false positive to your CEO.",
  },
  {
    q: "Where does my security data live?",
    a: "Your security data lives in a dedicated PostgreSQL database that you provision and control. You choose where to host it \u2014 AWS, DigitalOcean, your own data center, anywhere you like. SecureGraph connects to this database and writes assets, scan results, findings, and risks directly into it.\n\nHere is what we do not do: we do not store your security data in a shared multi-tenant cloud where your vulnerability list sits next to another company\u2019s. We do not read, copy, or store your production business database \u2014 your ERP, CRM, or customer data never touches us. The only data we keep on our side is what\u2019s needed to run your organization: login credentials, user roles, billing information, and setup configuration.\n\nIf you ever decide to leave SecureGraph, you walk away with every byte of your security data. It was never ours to hold hostage.",
  },
  {
    q: "Is the Free plan really free?",
    a: "Yes. No credit card required. No time-limited trial. You get real, usable functionality from day one.\n\nWith the Free plan you can create your organization, set up dual-control approvals, inventory your assets (domains, subdomains, IPs, APIs, mobile builds), run vulnerability scans and VAPT campaigns, keep one threat-modelling project from your product context, review pull requests and receive WhatsApp/Telegram channel alerts, and export every report type and format \u2014 PDF, DOCX, XLSX, HTML, PPTX, Markdown, JSON and CSV are free on every plan. You start with a one-time 500 AI credits, then continue on free open-source models.\n\nThere are fair-use caps on asset volume and users, and continuous coverage is reserved for Growth \u2014 continuous PR review, continuous pentesting, cloud and Kubernetes posture, the compliance workbench and the SOC alert console. But Free is not a crippled demo. It is a genuine starter surface that helps you know your security posture before you spend any money.",
  },
  {
    q: "How is this different from buying a scanner or other security tools?",
    a: "Most security tools are point solutions. A scanner finds vulnerabilities and dumps them on your desk. A separate tool handles compliance. Another one generates reports. You end up juggling five products, each with its own login, its own data format, and its own way of deciding what matters.\n\nSecureGraph replaces that stack with one platform. It discovers your assets, runs assessments (including VAPT campaigns with approval gates), separates verified findings from scanner noise, maps findings to compliance frameworks, and produces reports your leadership can read \u2014 all in one place.\n\nBut the biggest difference is data ownership. With most SaaS security tools, your vulnerability data lives on their servers. If you cancel, you may not get your history back. With SecureGraph, your security database is yours. You host it. You control access. You keep everything even if you stop using the platform.",
  },
  {
    q: "Will AI make things up or invent fake vulnerabilities?",
    a: "No. This is a common concern with AI in security, and we designed SecureGraph to avoid it completely.\n\nOur AI agents \u2014 SOC, GRC, VAPT, threat intelligence, asset, code and threat-modelling specialists \u2014 cannot create findings on their own. They can only read and explain what the engines have already discovered and stored in your database. They help you write up findings, suggest remediation steps, explain compliance gaps to auditors, and plan investigation sequences. They never assign risk scores, never change a finding, never bypass dual-control approvals, and never invent a vulnerability that does not exist.\n\nThey also act with exactly your permissions, never more. The agent calls the API as you: it sees what your role can see and can do only what your role can do. Nothing is inherited between turns or requests \u2014 every action that changes anything needs a fresh, single-use approval, and every action it takes is written to the same immutable audit trail, with its context and intent.\n\nEvery finding that appears in a report carries a verification state: auto-verified, manually verified, unverified, or rejected. Reports prioritize verified material. Unverified noise is quarantined to an appendix. This means your board and clients see only what you can stand behind.",
  },
  {
    q: "Can my team use this without a dedicated security person?",
    a: "That is exactly the team SecureGraph is built for. We call it the one-person security team \u2014 the engineer, IT manager, or operations lead who also handles security because someone has to.\n\nSecureGraph does not assume you have a SOC with three shifts. It assumes you have one person with limited time and a growing list of responsibilities. So the platform is designed to do the heavy lifting on its own: continuous asset discovery keeps your inventory current without manual effort, verification gates separate real risks from noise so you don\u2019t waste time chasing false positives, and reports are generated automatically from verified findings so you can send them to leadership without spending hours writing them up.\n\nWhen you need help, you summon an AI agent for a specific task \u2014 triaging an alert, writing up a finding, mapping a compliance gap. It works alongside you, not ahead of you. You stay in command of every decision.",
  },
  {
    q: "Do you support Nigerian companies and NDPA?",
    a: "Yes. Our architecture was designed from the start with data privacy as a foundation, not an afterthought. This makes alignment with Nigeria\u2019s Data Protection Act (NDPA) straightforward.\n\nHere is how: your security data stays in your own database on infrastructure you choose. Our AI paths prefer local or controlled models for routine work, and external model calls strip personal data before they leave your boundary. Every action on the platform is attributed, timestamped, and stored in an append-only audit trail \u2014 so when you need to demonstrate compliance, the evidence is ready.\n\nSecureGraph helps you prepare for certification by mapping findings to framework controls and producing audit-ready evidence packages. But your legal certification remains your responsibility \u2014 we are the tool that helps you build the case, not the auditor who approves it.",
  },
  {
    q: "What if I need a full penetration test from human experts?",
    a: "If your assessment needs go beyond what your team can run internally, we offer engagements. These are human-led penetration tests delivered by SecureGraph security professionals, working on top of the same platform you use daily.\n\nThe advantage is continuity. Your external VAPT campaign is scoped, run, and reported inside your existing SecureGraph environment. Findings flow through the same verification gate and impact analysis as your internal assessments. You get a single source of truth for all findings \u2014 whether they came from your team or from ours \u2014 instead of stitching together reports from multiple vendors.\n\nEngagements cover full external and internal VAPT, complex application testing, mobile dynamic testing, and guided onboarding with board reporting. Contact us through the site to discuss scope and pricing.",
  },
  {
    q: "How do I get started?",
    a: "Click \u2018Get started free\u2019 on this page. You will create your organization, verify your email, and set up your first users.\n\nNext, provision a dedicated PostgreSQL database on any infrastructure you prefer \u2014 AWS RDS, DigitalOcean, a server in your office. SecureGraph connects to it and handles the rest. You can inventory your first assets \u2014 domains, public GitHub repositories, APIs \u2014 within minutes.\n\nRun a light assessment, see your first findings flow through the verification pipeline, and export a report. From registration to first report, many teams complete the full cycle in under an hour. Start with Free, then move to Starter for the full engine and more projects, and to Growth when you need continuous coverage, cloud and Kubernetes posture, and the compliance and SOC consoles. No card required to begin.",
  },
];
