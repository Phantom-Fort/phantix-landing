...
/*
 * saa-s-template — a self-contained SaaS landing template.
 *
 * Adapted for this codebase:
 *  - inline SVG icons replaced with lucide-react (already a dependency)
 *  - the Google Fonts `@import` + global `* { font-family: Poppins }` override
 *    were removed — the site already owns its font stack (Geist) in index.css,
 *    and a template must never reset typography globally
 *  - placeholder 21st.dev CDN images swapped for stable Unsplash assets
 */
